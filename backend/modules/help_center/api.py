...
from modules.help_center.service import HelpCenterService
...
async def create_ticket(
    ...
    paths_str = await HelpCenterService.save_screenshots(screenshots)
    now = datetime.now()
...
from modules.help_center.schemas import StatusUpdate
