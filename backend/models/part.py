...
class Client(Base):
    """Maps to `clients` table — Directory of clients/customers."""
...
class ProjectIncharge(Base):
    """Maps to `project_incharges` table — Directory of project incharges."""
    __tablename__ = "project_incharges"
