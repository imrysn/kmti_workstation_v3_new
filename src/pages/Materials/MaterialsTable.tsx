...
// Reuse the same Highlight component pattern
...
const MaterialsTable: React.FC<MaterialsTableProps> = memo(({
  query,
  setQuery,
  results,
  loading,
                  ...
                  >
                    ...
                    {canManage && (
                      <td className="actions-cell">
                        <button className="icon-btn edit" onClick={() => onEdit?.(r)} title="Edit Material">
                          <EditIcon size={16} />
                        </button>
                        <button className="icon-btn delete" onClick={() => onDelete?.(r)} title="Delete Material">
                          <TrashIcon size={16} />
                        </button>
                      </td>
                    )}
