...
export default function QuotationEntryModal({ onJoin, onCreateNew, onStartTutorial, onClose, mandatory }: Props) {
  ...
  return (
    <div className="quot-entry-overlay">
        ...
        <div className="quot-entry-card">
          ...
          {!isCreating && !joiningSession && (
            <footer className="quot-entry-footer">
              <button className="quot-footer-btn btn-start-workspace" onClick={() => setIsCreating(true)}>
              ...
              <button className="quot-footer-btn quot-btn-secondary btn-open-library" onClick={() => setIsLibraryOpen(true)}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <LobbyTutorial
        isOpen={isLobbyTutorialOpen}
        onClose={() => setIsLobbyTutorialOpen(false)}
        onComplete={() => {
          setIsLobbyTutorialOpen(false)
          onStartTutorial()
        }}
      />
    </div>
